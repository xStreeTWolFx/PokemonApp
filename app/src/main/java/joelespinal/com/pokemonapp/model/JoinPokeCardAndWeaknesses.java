...
public class JoinPokeCardAndWeaknesses {
    @Id
    ...
    @Generated(hash = 506759730)
    public JoinPokeCardAndWeaknesses(Long id, Long pokeCardId, Long keyValueId) {
        this.id = id;
        this.pokeCardId = pokeCardId;
        this.keyValueId = keyValueId;
    }

    @Generated(hash = 228718349)
    public JoinPokeCardAndWeaknesses() {
    }
